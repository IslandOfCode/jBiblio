...
<html>
	...
	<body>
		...
		<table style="border-collapse: collapse; width:90%; margin:auto">
			<tr>
				<td><i>Nominativo:</i></td>
				<td><b>${nameClient}</b></td>
				
				<td><i>Classe:</i></td>
				<td><b>${classClient}</b></td>
			</tr>
			<tr>
				<td><i>Data inizio prestito:</i></td>
				<td><b>${dateStart}</b></td>
				
				<td><i>Data fine prestito:</i></td>
				<td><b>${dateEnd}</b></td>
			</tr>
			<tr>
				<td><i>Codice prestito:</i></td>
				<td><b>${codeLoan}</b></td>
				
				<td><i>Stato:</i></td>
				<td><b>${statusLoan}</b></td>
			</tr>
		</table>
		
		<p>Lista libri inclusi nel prestito</p>
		...
		<tbody>
			<#list listaLibri as libro>
				<tr>
					<td class="destra">${libro.ISBN}</td>
					<td class="destra">${libro.title!""}</td>
					<td class="destra">${libro.collocation}</td>
				</tr>
			</#list>
		</tbody>
		</table>
		...
		<table style="float:right; width:30%">
			<tr>
				<td style="text-align:center"><i>Firma:</i></td>
			</tr>
			<tr>
				<td style="text-align:center; height:48px">_________________________________</td>
			</tr>
		</table>
