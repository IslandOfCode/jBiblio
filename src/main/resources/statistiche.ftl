...
<html>
	...
	<body>
		<div id="logo">
			...
			<span class="title">LIBRERIA SCOLASTICA</span><br/><br/>
			<span class="subtitle">${titoloOwner}: ${nomeOwner}</span>
		</div>
		<br/>
		<hr style="width:95%"/>
		
		<p style="text-align:center; font-size: 16pt; font-weight: bold; font-style:italic">La libreria in cifre</p>
		
		<table class="cinereo" style="width:50% !important; margin:auto">
			<thead>
				<th>Totale libri</th>
		...
		<br/>
		<p style="text-align:center; font-size: 16pt; font-weight: bold; font-style:italic">Prestiti per mese (a.s. 00/01)</p>
		
		<table class="cinereo" style="width:85% !important; margin:auto">
			<thead>
				<th>GEN</th>
				<th>FEB</th>
				<th>MAR</th>
		...
		<p style="font-size: 14pt; text-align:center">In totale sono stati prestati <span style="font-size: 18pt; font-weight:bold">00</span> libri quest'anno.</p>
		
		<p style="text-align:center; font-size: 16pt; font-weight: bold; font-style:italic">TOP 10</p>
		<table class="cinereo" style="width:70% !important; margin:auto">
			<thead>
				<th>Top 10<br/>libri più richiesti</th>
				<th>Top 10<br/>classi più attive</th>
			</thead>
			<tbody>
				<td>
					<ol>
		...
		<ul style="margin-left: 5%">
			<li>Giorni di prestito: 15.</li>
			<li>Media giorni di ritardo: XX giorni.</li>
			<li>Prestiti in ritardo sul totale: AA su BB.</li>
		</ul>
